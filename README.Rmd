...
# SeuratExtra
The goal of SeuratExtra is to provide enhanced visualization tools for single-cell RNA-seq data analysis.

## Installation

You can install the development version of SeuratExtra from [https://github.com/zhangsyhub/SeuratExtra] with:
...
This is a basic example which shows you how to create a journal-quality UMAP plot using DimPlot_ex::
...
```
## Contributing
Feel free to submit issues or pull requests to improve the conversion logic!
